/**
 * Split text info chunks for better AI processing
...
export const chunkText = (text, chunkSize = 500, overlap = 50) => {
  ...
  //Try to split by paragraphs (single or doouble newlines)
  ...
  for (const paragraph of paragraphs) {
    ...
    if (paragraphWordCount > chunkSize) {
      ...
      //Split large paragraph info word-based chunks
