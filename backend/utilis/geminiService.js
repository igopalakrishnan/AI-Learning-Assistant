...
if (!process.env.GEMINI_API_KEY) {
  console.error(
    "Fail ERROR: GEMINI_API_KEY is not set in the environment variables.",
  );
  process.exit();
}

/**
 * Generate flashcardfrom text
 * @param {string} text - Documnet text
 ...
 * @param {Array<Object>} chunks - User question
 * @returns {Promise<string>}
 */
...
export const explainConcept = async (concept, context) => {
  const prompt = `Explain the concept of "${concept}" based on the following context.
    Provide a clear, edducational that's easy to understand.
