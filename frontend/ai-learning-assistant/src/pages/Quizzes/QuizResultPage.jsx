    ...
    <div className="max-w-5xl mx-auto">
              ...
              {result.explanation && (
                <div className="p-4 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl">
                  <div className="flex items-start gap-3">
                    <div className="shrink-0 w-8 rounded-lg bg-slate-200 flex items-center justify-center mt-0.5">
                      <BookOpen
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/documents/${data.document._id}`}>
          <button className="group relative px-8 h-12 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-xs rounded-xl transition-all duration-200 shadow-emerald-500/25 active:scale-95 overflow-hidden">
