...
const AIActions = () => {
  ...
  const handleGenerateSummary = async () => {
    ...
    try {
      ...
      const summary = result.data?.summary || result.summary; // handle both shapes
  ...
  const handleExplainConcept = async (e) => {
    ...
    try {
      ...
      const explanation = result.data?.explanation; // consistent access
      ...
      <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
            <div className="flex items-start justify-beween gap-4">
              ...
              <button
                ...
                className="shrink-0 h-10 px-5 bg-linear-to-r from-emerald-500 to-teal-600 hover:from-teal-600 to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
              >
          ...
          <div className="group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
            <form onSubmit={handleExplainConcept}>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-8 h-8 rounded-lg bg-linear-to-br from-smber-100 to-orange-100 flex items-center justify-center">
                  <Lightbulb
              ...
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
                Enter a topic or concept fron the document to get a detailed
                explanation.
              </p>
              <div className="flex items-center gap-3">
                <input
