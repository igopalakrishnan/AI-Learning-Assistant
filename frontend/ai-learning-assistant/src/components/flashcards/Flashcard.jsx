  ...
  return (
    <div className="relative w-full h-72" style={{ perspective: "1000px" }}>
      ...
      >
        ...
        <div
          className="absolute inset-0 w-full h-full bg-white/80 backdrop-blur-xl border-2 border-slate-200/6 rounded-2xl shadow-xl shadow-slate-200/50 p-8 flex flex-col justify-between"
          style={{
        ...
        >
          ...
          {/* Flip Indicator */}
          <div className="flex items-center justify-center gap-2 text-xs text-white/70 font-mediu">
            <RotateCcw className="w-3.5 h-3.5" strokeWidth={2} />
