...
const QuizManager = ({ documentId }) => {
  ...
  const fetchQuizzes = async () => {
    setLoading(true);
    try {
      const result = await quizService.getQuizzesForDocument(documentId);
      setQuizzes(result.data || []); // <-- use the array inside data
    } catch (error) {
  ...
  const handleDeleteRequest = (quiz) => {
    console.log("Quiz selected for deletion:", quiz);
